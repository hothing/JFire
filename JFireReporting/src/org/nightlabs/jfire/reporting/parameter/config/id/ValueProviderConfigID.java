...
package org.nightlabs.jfire.reporting.parameter.config.id;
...
/**
 * The JDO object id class for {@link org.nightlabs.jfire.reporting.parameter.config.ValueProviderConfig}.
 * <p>This class was auto-generated.</p>
 */
@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
public class ValueProviderConfigID
implements ObjectID
{
	/**
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	private static final long serialVersionUID = -1456582567L;
	 ...
	 * Declared as primary key field in {@link org.nightlabs.jfire.reporting.parameter.config.ValueProviderConfig}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String organisationID;

	/**
	 * Primary key field valueAcquisitionSetupID.
	 * Declared as primary key field in {@link org.nightlabs.jfire.reporting.parameter.config.ValueProviderConfig}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public long valueAcquisitionSetupID;

	/**
	 * Primary key field valueProviderOrganisationID.
	 * Declared as primary key field in {@link org.nightlabs.jfire.reporting.parameter.config.ValueProviderConfig}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String valueProviderOrganisationID;

	/**
	 * Primary key field valueProviderCategoryID.
	 * Declared as primary key field in {@link org.nightlabs.jfire.reporting.parameter.config.ValueProviderConfig}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String valueProviderCategoryID;

	/**
	 * Primary key field valueProviderID.
	 * Declared as primary key field in {@link org.nightlabs.jfire.reporting.parameter.config.ValueProviderConfig}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String valueProviderID;

	/**
	 * Primary key field valueProviderConfigID.
	 * Declared as primary key field in {@link org.nightlabs.jfire.reporting.parameter.config.ValueProviderConfig}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public long valueProviderConfigID;

	/**
	 * Create a new empty instance of ValueProviderConfigID.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public ValueProviderConfigID()
	{
	}

	/**
	 * Create a new instance of ValueProviderConfigID.
	 ...
	 * <code>ValueProviderConfigID newValueProviderConfigID = new ValueProviderConfigID(oldValueProviderConfigID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public ValueProviderConfigID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends ValueProviderConfigID> clazz = this.getClass();
	 ...
	 * {@link #ValueProviderConfigID(String)}.
	...
	public String toString()
	{
		...
		try {
			...
			sb.append('&');
			sb.append("valueAcquisitionSetupID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(Long.toString(valueAcquisitionSetupID, RADIX), ENCODING));
			sb.append('&');
			sb.append("valueProviderOrganisationID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(String.valueOf(valueProviderOrganisationID), ENCODING));
			sb.append('&');
			sb.append("valueProviderCategoryID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(String.valueOf(valueProviderCategoryID), ENCODING));
			sb.append('&');
			sb.append("valueProviderID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(String.valueOf(valueProviderID), ENCODING));
			sb.append('&');
			sb.append("valueProviderConfigID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(Long.toString(valueProviderConfigID, RADIX), ENCODING));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		ValueProviderConfigID other = (ValueProviderConfigID) obj;
		...
		if(valueProviderOrganisationID == null) {
			if(other.valueProviderOrganisationID != null)
				return false;
		} else if(!valueProviderOrganisationID.equals(other.valueProviderOrganisationID))
			return false;
		if(valueProviderCategoryID == null) {
			if(other.valueProviderCategoryID != null)
				return false;
		} else if(!valueProviderCategoryID.equals(other.valueProviderCategoryID))
			return false;
	...
	public int hashCode()
	{
		...
		result = prime * result + (int) (valueAcquisitionSetupID ^ (valueAcquisitionSetupID >>> 32));
		result = prime * result + ((valueProviderOrganisationID == null) ? 0 : valueProviderOrganisationID.hashCode());
		result = prime * result + ((valueProviderCategoryID == null) ? 0 : valueProviderCategoryID.hashCode());
		result = prime * result + ((valueProviderID == null) ? 0 : valueProviderID.hashCode());
		result = prime * result + (int) (valueProviderConfigID ^ (valueProviderConfigID >>> 32));
		return result;
	}
	 ...
	 * @param valueAcquisitionSetupID The primary key field valueAcquisitionSetupID.
	 * @param valueProviderOrganisationID The primary key field valueProviderOrganisationID.
	 * @param valueProviderCategoryID The primary key field valueProviderCategoryID.
	 * @param valueProviderID The primary key field valueProviderID.
	 * @param valueProviderConfigID The primary key field valueProviderConfigID.
	 * @return a newly created instance of <code>ValueProviderConfigID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static ValueProviderConfigID create(String organisationID, long valueAcquisitionSetupID, String valueProviderOrganisationID, String valueProviderCategoryID, String valueProviderID, long valueProviderConfigID)
	{
		ValueProviderConfigID n = new ValueProviderConfigID();
		n.organisationID = organisationID;
		n.valueAcquisitionSetupID = valueAcquisitionSetupID;
		n.valueProviderOrganisationID = valueProviderOrganisationID;
		n.valueProviderCategoryID = valueProviderCategoryID;
		n.valueProviderID = valueProviderID;
		n.valueProviderConfigID = valueProviderConfigID;
		return n;
	}
