package org.nightlabs.jfire.reporting.classloader;
 ...
 *
 */
public class ReportingClassLoader
extends URLClassLoader
{
	private static final Logger logger = Logger.getLogger(ReportingClassLoader.class);
...
//	private volatile ClassLoader osgiClassLoader;
	...
	private static ReportingClassLoader sharedInstance = null;
	...
	public synchronized static ReportingClassLoader createSharedInstance(URL[] additionalUrls)
	{
...
//		}
		...
		sharedInstance = new ReportingClassLoader(
				urls.toArray(new URL[urls.size()]),
				ReportingClassLoader.class.getClassLoader()
		);

		return sharedInstance;
	}

	public synchronized static ReportingClassLoader sharedInstance() {
		if (sharedInstance == null)
