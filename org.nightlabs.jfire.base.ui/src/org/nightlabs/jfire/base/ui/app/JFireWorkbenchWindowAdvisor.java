...
//		PlatformUI.getWorkbench().getProgressService().setJobErrorNotificationManager(new JobErrorNotificationManager());
	...
	public void createWindowContents(Shell shell) {
		...
		LoginStateStatusLineContribution loginState = new LoginStateStatusLineContribution(Messages.getString("org.nightlabs.jfire.base.ui.app.JFireActionBuilder.loginStatus")); //$NON-NLS-1$
