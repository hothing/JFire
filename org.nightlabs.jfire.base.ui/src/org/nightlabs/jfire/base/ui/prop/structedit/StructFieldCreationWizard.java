...
public class StructFieldCreationWizard extends DynamicPathWizard {
	private class StructFieldTypePage extends DynamicPathWizardPage {
		...
		public StructFieldTypePage() {
			super(StructFieldTypePage.class.getName(), Messages.getString("org.nightlabs.jfire.base.ui.prop.structedit.StructFieldCreationWizard.StructFieldTypePage.title")); //$NON-NLS-1$
		...
		public Control createPageContents(Composite parent) {
			...
			new Label(comp, SWT.NONE).setText(Messages.getString("org.nightlabs.jfire.base.ui.prop.structedit.StructFieldCreationWizard.StructFieldTypePage.availableTypesLabel.text")); //$NON-NLS-1$
