...
class NumberStructFieldEditComposite extends XComposite {
	...
	private Composite createSpinnerComposite(Composite parent, boolean integer) {
		...
		new Label(comp, SWT.NONE).setText(Messages.getString("org.nightlabs.jfire.base.ui.prop.structedit.NumberStructFieldEditComposite.digitsLabel.text")); //$NON-NLS-1$
		...
		new Label(comp, SWT.NONE).setText(Messages.getString("org.nightlabs.jfire.base.ui.prop.structedit.NumberStructFieldEditComposite.boundedLabel.text")); //$NON-NLS-1$
		...
		new Label(boundsComp, SWT.NONE).setText(Messages.getString("org.nightlabs.jfire.base.ui.prop.structedit.NumberStructFieldEditComposite.minimumLabel.text")); //$NON-NLS-1$
		minSpinner = new Spinner(boundsComp, SWT.BORDER);
		new Label(boundsComp, SWT.NONE).setText(Messages.getString("org.nightlabs.jfire.base.ui.prop.structedit.NumberStructFieldEditComposite.maximumLabel.text")); //$NON-NLS-1$
