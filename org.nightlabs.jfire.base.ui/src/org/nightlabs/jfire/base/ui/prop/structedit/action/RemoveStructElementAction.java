...
public class RemoveStructElementAction extends SelectionAction {
	...
	public RemoveStructElementAction(StructEditor editor) {
		super(
				Messages.getString("org.nightlabs.jfire.base.ui.prop.structedit.action.RemoveStructElementAction.text"), //$NON-NLS-1$
				SharedImages.DELETE_16x16); // TODO: needs an own icon!
		this.editor = editor;
		setToolTipText(Messages.getString("org.nightlabs.jfire.base.ui.prop.structedit.action.RemoveStructElementAction.toolTipText")); //$NON-NLS-1$
	}
