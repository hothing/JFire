...
public class PersonStructOrderComposite extends Composite {
	...
	public PersonStructOrderComposite(Composite parent, int style) {
		...
		titleLabel.setText(Messages.getString("org.nightlabs.jfire.base.ui.person.preferences.PersonStructOrderComposite.titleLabel.text")); //$NON-NLS-1$
		...
		structBlocksGroup.setText(Messages.getString("org.nightlabs.jfire.base.ui.person.preferences.PersonStructOrderComposite.structBlocksGroup.text")); //$NON-NLS-1$
...
//		blocksButtonsCompositeLayout.verticalSpacing = 0;
		...
		blockUpButton.setText(Messages.getString("org.nightlabs.jfire.base.ui.person.preferences.PersonStructOrderComposite.blockUpButton.text")); //$NON-NLS-1$
		...
		blockDownButton.setText(Messages.getString("org.nightlabs.jfire.base.ui.person.preferences.PersonStructOrderComposite.blockDownButton.text")); //$NON-NLS-1$
		...
		structFieldsGroup.setText(Messages.getString("org.nightlabs.jfire.base.ui.person.preferences.PersonStructOrderComposite.structFieldsGroup.text")); //$NON-NLS-1$
		...
		fieldUpButton.setText(Messages.getString("org.nightlabs.jfire.base.ui.person.preferences.PersonStructOrderComposite.fieldUpButton.text")); //$NON-NLS-1$
		buttonLData = new GridData(GridData.FILL_HORIZONTAL);
		buttonLData.horizontalIndent = 0;
		buttonLData.horizontalIndent = 0;
		...
		fieldDownButton.setText(Messages.getString("org.nightlabs.jfire.base.ui.person.preferences.PersonStructOrderComposite.fieldDownButton.text")); //$NON-NLS-1$
		buttonLData = new GridData(GridData.FILL_HORIZONTAL);
		buttonLData.horizontalIndent = 0;
		buttonLData.horizontalIndent = 0;
