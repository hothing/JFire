...
//		firstRow.setLayout(firstRowLayout);
		...
		controlName = new LabeledText(firstRow, Messages.getString("org.nightlabs.jfire.base.ui.person.search.StaticPersonSearchFilterProviderComposite.name.caption")); //$NON-NLS-1$
		...
		controlPersonID = new LabeledText(firstRow, Messages.getString("org.nightlabs.jfire.base.ui.person.search.StaticPersonSearchFilterProviderComposite.personID.caption")); //$NON-NLS-1$
...
//		secondRow.setLayout(secondRowLayout);
		...
		controlAddress = new LabeledText(secondRow, Messages.getString("org.nightlabs.jfire.base.ui.person.search.StaticPersonSearchFilterProviderComposite.address.caption")); //$NON-NLS-1$
		...
		controlPostCode = new LabeledText(secondRow, Messages.getString("org.nightlabs.jfire.base.ui.person.search.StaticPersonSearchFilterProviderComposite.postcode.caption")); //$NON-NLS-1$
		...
		controlCity = new LabeledText(secondRow, Messages.getString("org.nightlabs.jfire.base.ui.person.search.StaticPersonSearchFilterProviderComposite.city.caption")); //$NON-NLS-1$
		...
		controlPhone = new LabeledText(thirdRow, Messages.getString("org.nightlabs.jfire.base.ui.person.search.StaticPersonSearchFilterProviderComposite.phone.caption")); //$NON-NLS-1$
...
//		controlPhoneLData.widthHint = 160;
		...
		controlEmail = new LabeledText(thirdRow, Messages.getString("org.nightlabs.jfire.base.ui.person.search.StaticPersonSearchFilterProviderComposite.email.caption")); //$NON-NLS-1$
