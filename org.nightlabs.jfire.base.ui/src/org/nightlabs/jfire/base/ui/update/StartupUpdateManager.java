...
package org.nightlabs.jfire.base.ui.update;
...
import org.nightlabs.jfire.base.ui.login.LoginConfigModule;
...
public class StartupUpdateManager implements IProgressMonitor, Runnable
{
	...
	public void run()
	{
//		SplashScreen.setSplashMessage(Messages.getString("org.nightlabs.jfire.base.ui.update.StartupUpdateManager.splashScreen.message_checkingForUpdates")); //$NON-NLS-1$
		try
		{
