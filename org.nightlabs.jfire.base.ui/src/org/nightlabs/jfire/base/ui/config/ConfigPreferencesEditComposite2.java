...
//		treeComposite = new ConfigPreferencesTreeComposite(wrapper, XComposite.getBorderStyle(wrapper), false, null);
	...
	public void setCurrentConfigID(final ConfigID currentConfigID) {
		...
		Job lockJob = new Job(Messages.getString("org.nightlabs.jfire.base.ui.config.ConfigPreferencesEditComposite2.lockCheckJob")) { //$NON-NLS-1$
			@Override
			protected IStatus run(ProgressMonitor monitor) {
				monitor.beginTask(Messages.getString("org.nightlabs.jfire.base.ui.config.ConfigPreferencesEditComposite2.initialising"), 2); //$NON-NLS-1$
