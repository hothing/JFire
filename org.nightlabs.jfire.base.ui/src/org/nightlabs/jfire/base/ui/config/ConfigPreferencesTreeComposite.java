...
import org.nightlabs.jfire.base.ui.config.ConfigSetupRegistry.NoSetupPresentException;
...
public class ConfigPreferencesTreeComposite extends AbstractTreeComposite<ConfigPreferenceNode> {
	...
	public ConfigPreferencesTreeComposite(Composite parent, int style, boolean setLayoutData, ConfigID configID) {
		...
		// TODO WORKAROUND: I cannot expand the tree in my UI (and collapse doesn't work either). I don't know, if this is due to KDE 4.3 or sth. else. But this workaround (expanding it) seems to work fine.
		setRestoreCollapseState(false);
		// END WORKAROUND
	}
