...
extends AbstractTableComposite<User>
{
	...
	protected void createTableColumns(TableViewer tableViewer, Table table)
	{
		...
		new TableColumn(table, SWT.LEFT).setText(Messages.getString("org.nightlabs.jfire.base.ui.security.UserTable.description")); //$NON-NLS-1$
		new TableColumn(table, SWT.LEFT).setText(Messages.getString("org.nightlabs.jfire.base.ui.security.UserTable.userType")); //$NON-NLS-1$
		new TableColumn(table, SWT.LEFT).setText(Messages.getString("org.nightlabs.jfire.base.ui.security.UserTable.changeDT")); //$NON-NLS-1$
