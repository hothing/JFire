/*
 * $Id: Librarian.java 2163 2008-05-18 13:48:36Z jponge $ 
...
public class Librarian implements CleanupClient
{
    ...
    public synchronized void loadArchSpecificLibrary(String name, NativeLibraryClient client) throws Exception
    {
        ...
        if (System.getProperty("DLL_PATH") != null)
        {
            ...
            System.out.println("Try to load library " + path);
            System.load(path);
            return;
        ...
        // XXX: removed the conditional. 
        // The jar procedure should always work. especially using onejar which uses a different protocol. Marc
