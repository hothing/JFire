...
public class VoucherTypeDetailServlet extends WebShopServlet
{
	...
	public static final String[] VOUCHER_DETAIL_FETCH_GROUPS = new String [] {
...
//					voucherPriceConfig.createPriceID(),
			...
			voucherPrice.setAmount(PriceFragmentTypeDAO.sharedInstance().getPriceFragmentType(PriceFragmentType.PRICE_FRAGMENT_TYPE_ID_TOTAL,
