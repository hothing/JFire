...
implements IViewActionDelegate
{
	...
	public void run(IAction arg0)
	{
		...
		Job job = new Job(Messages.getString("org.nightlabs.jfire.base.admin.ui.asyncinvoke.RetryViewAction.job.retryAsyncInvocations")) //$NON-NLS-1$
		{
			@Override
			protected IStatus run(ProgressMonitor monitor)
					throws Exception
			{
				AsyncInvokeProblemDAO.sharedInstance().retryAsyncInvokeProblems(asyncInvokeProblemIDs);
