...
import org.nightlabs.editor2d.ui.command.DeletePageCommand;
...
extends AbstractEditorAction
{
	...
	protected void init()
	{
		super.init();
		setId(ID);
		setText(Messages.getString("org.nightlabs.editor2d.ui.actions.DeletePageAction.text")); //$NON-NLS-1$
		setToolTipText(Messages.getString("org.nightlabs.editor2d.ui.actions.DeletePageAction.tooltip")); //$NON-NLS-1$
