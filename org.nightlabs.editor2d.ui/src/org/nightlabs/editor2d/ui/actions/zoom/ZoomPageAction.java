 ...
 *                                                                             *
 ******************************************************************************/
package org.nightlabs.editor2d.ui.actions.zoom;
...
extends AbstractEditorAction
{
	...
	public ZoomPageAction(AbstractEditor editor, ZoomManager zoomManager)
	{
		...
		setId(ID);
		setText(Messages.getString("org.nightlabs.editor2d.ui.actions.zoom.ZoomPageAction.text")); //$NON-NLS-1$
		setToolTipText(Messages.getString("org.nightlabs.editor2d.ui.actions.zoom.ZoomPageAction.tooltip")); //$NON-NLS-1$
