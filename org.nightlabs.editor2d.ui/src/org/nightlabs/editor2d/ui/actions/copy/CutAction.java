 ...
 *                                                                             *
 ******************************************************************************/
package org.nightlabs.editor2d.ui.actions.copy;
...
import org.nightlabs.editor2d.ui.actions.EditorActionConstants;
import org.nightlabs.editor2d.ui.command.CutDrawComponentCommand;
...
extends AbstractEditorSelectionAction
{
	...
	public void init()
	{
		...
		setToolTipText(Messages.getString("org.nightlabs.editor2d.ui.actions.copy.CutAction.tooltip")); //$NON-NLS-1$
