...
import org.nightlabs.editor2d.ui.command.shape.ShapeUnionCommand;
...
extends AbstractBooleanOperationAction
{
	...
	protected void init()
	{
		...
		setToolTipText(Messages.getString("org.nightlabs.editor2d.ui.actions.shape.ShapeUnionAction.tooltip"));		 //$NON-NLS-1$
	}
