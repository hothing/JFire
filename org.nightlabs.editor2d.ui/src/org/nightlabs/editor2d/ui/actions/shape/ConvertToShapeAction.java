...
import org.nightlabs.editor2d.ui.command.shape.ConvertToShapeCommand;
...
extends AbstractEditorSelectionAction
{
	...
	protected void init()
	{
		...
		setToolTipText(Messages.getString("org.nightlabs.editor2d.ui.actions.shape.ConvertToShapeAction.tooltip"));		 //$NON-NLS-1$
	}
