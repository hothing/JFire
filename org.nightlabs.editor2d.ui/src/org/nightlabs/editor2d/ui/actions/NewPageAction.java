...
import org.nightlabs.editor2d.ui.command.CreatePageCommand;
...
extends AbstractEditorAction
{
	...
	protected void init()
	{
		super.init();
		setId(ID);
		setText(Messages.getString("org.nightlabs.editor2d.ui.actions.NewPageAction.text")); //$NON-NLS-1$
		setToolTipText(Messages.getString("org.nightlabs.editor2d.ui.actions.NewPageAction.tooltip")); //$NON-NLS-1$
