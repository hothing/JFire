...
//		alignData.verticalAlignment = SWT.CENTER;
		...
		alignHorizontal.setText(Messages.getString("org.nightlabs.editor2d.ui.print.J2DPrintDialog.button.horizontal")); //$NON-NLS-1$
		alignVertical = new Button(alignmentGroup, SWT.RADIO);
		alignVertical.setText(Messages.getString("org.nightlabs.editor2d.ui.print.J2DPrintDialog.button.vertical"));		 //$NON-NLS-1$
