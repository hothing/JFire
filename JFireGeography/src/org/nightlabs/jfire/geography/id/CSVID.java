...
/**
 * The JDO object id class for {@link org.nightlabs.jfire.geography.CSV}.
...
implements ObjectID
{
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	private static final long serialVersionUID = -2080954172L;
	 ...
	 * Declared as primary key field in {@link org.nightlabs.jfire.geography.CSV}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String organisationID;

	/**
	 * Primary key field csvType.
	 * Declared as primary key field in {@link org.nightlabs.jfire.geography.CSV}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String csvType;

	/**
	 * Primary key field countryID.
	 * Declared as primary key field in {@link org.nightlabs.jfire.geography.CSV}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String countryID;

	/**
	 * Create a new empty instance of CSVID.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public CSVID()
	{
	...
	/**
	 * Create a new instance of CSVID.
	 ...
	 * <code>CSVID newCSVID = new CSVID(oldCSVID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public CSVID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends CSVID> clazz = this.getClass();
	...
	public String toString()
	{
		...
		try {
			...
			sb.append('&');
			sb.append("csvType="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(String.valueOf(csvType), ENCODING));
			sb.append('&');
			sb.append("countryID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(String.valueOf(countryID), ENCODING));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj)
	{
		...
		if(organisationID == null) {
			...
			return false;
		if(csvType == null) {
			if(other.csvType != null)
				return false;
		} else if(!csvType.equals(other.csvType))
			return false;
		if(countryID == null) {
	...
	public int hashCode()
	{
		...
		result = prime * result + ((csvType == null) ? 0 : csvType.hashCode());
	 ...
	 * @param csvType The primary key field csvType.
	 * @param countryID The primary key field countryID.
	 * @return a newly created instance of <code>CSVID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static CSVID create(String organisationID, String csvType, String countryID)
	{
		CSVID n = new CSVID();
