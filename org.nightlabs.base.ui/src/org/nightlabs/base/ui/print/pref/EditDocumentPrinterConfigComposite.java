...
public class EditDocumentPrinterConfigComposite extends XComposite {
	...
	protected void initGUI() {
		...
		typeGroup.setText(Messages.getString("org.nightlabs.base.ui.print.pref.EditDocumentPrinterConfigComposite.typeGroup.text")); //$NON-NLS-1$
		typeGroup.setLayout(new RowLayout(SWT.VERTICAL));

		typeSysCall = new Button(typeGroup, SWT.RADIO);
		typeSysCall.setText(Messages.getString("org.nightlabs.base.ui.print.pref.EditDocumentPrinterConfigComposite.typeSysCall.text")); //$NON-NLS-1$
		...
		typeExtEngine.setText(Messages.getString("org.nightlabs.base.ui.print.pref.EditDocumentPrinterConfigComposite.typeExtEngine.text")); //$NON-NLS-1$
		...
		commandPattern = new LabeledText(sysCallEditComposite, Messages.getString("org.nightlabs.base.ui.print.pref.EditDocumentPrinterConfigComposite.commandPattern.caption")); //$NON-NLS-1$
		parameterPattern = new LabeledText(sysCallEditComposite, Messages.getString("org.nightlabs.base.ui.print.pref.EditDocumentPrinterConfigComposite.parameterPattern.caption")); //$NON-NLS-1$

		extEngineEditComposite = new XComposite(editWrapper, SWT.NONE);
		className = new LabeledText(extEngineEditComposite, Messages.getString("org.nightlabs.base.ui.print.pref.EditDocumentPrinterConfigComposite.className.caption")); //$NON-NLS-1$
