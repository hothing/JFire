...
public class MonthlyTimePatternBuilderHopPage extends WizardHopPage {
	...
	public Control createPageContents(Composite parent) {
		...
		dayWrapper.setText(Messages.getString("org.nightlabs.base.ui.timepattern.builder.MonthlyTimePatternBuilderHopPage.dayWrapper.text")); //$NON-NLS-1$
		...
		monthWrapper.setText(Messages.getString("org.nightlabs.base.ui.timepattern.builder.MonthlyTimePatternBuilderHopPage.monthWrapper.text")); //$NON-NLS-1$
