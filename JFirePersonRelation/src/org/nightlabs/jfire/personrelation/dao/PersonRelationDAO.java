...
//	public synchronized Map<PropertySetID, Map<Class<? extends ObjectID>, List<Deque<ObjectID>>>> getRelationRootNodes(Set<PersonRelationTypeID> allowedRelations,
...
//			ejb = JFireEjb3Factory.getRemoteBean(PersonRelationManagerRemote.class, SecurityReflector.getInitialContextProperties());
//			monitor.worked(2);
//			Map<PropertySetID, Map<Class<? extends ObjectID>, List<Deque<ObjectID>>>> result = ejb.getRootNodes(allowedRelations, personIDs, maxDepth);
//			monitor.worked(8);
//			monitor.done();
//			return result;
//		}
